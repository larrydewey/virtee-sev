...
impl From<TcbVersion> for u64 {
    fn from(value: TcbVersion) -> Self {
        u64::from_le_bytes(value.to_bytes())
    }
}
...
mod tests {
    ...
    fn test_tcb_version_to_bytes() {
        ...
        assert_eq!(bytes, [1, 2, 0, 0, 0, 0, 7, 8]);
    }
    ...
    fn test_to_u64() {
        ...
        assert_eq!(value, 0x0807000000000201);
        ...
        let value: u64 = tcb.into();
        assert_eq!(value, 0xFFFF00000000FFFF);
    }
    ...
    fn test_byte_order() {
        ...
        let original_bytes = [0x01, 0x02, 0x0, 0x0, 0x0, 0x0, 0x07, 0x08];
